...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BidMachinePlus",
            url: "https://bidmachine-ios.s3.amazonaws.com/BidMachinePlus/1.0.0-test.11/package/BidMachinePlus.xcframework.zip",
            checksum: "a9cb9cf81e38d9223ee09b36c66a87f3a1b482a61bef2d27adcab5ef842b1797"
        ),
        .binaryTarget(
            name: "BidMachine",
